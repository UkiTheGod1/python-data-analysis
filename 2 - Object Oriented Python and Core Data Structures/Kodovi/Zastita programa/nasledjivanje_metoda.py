...
e1 = SalesManager("Alice", "alice@brightsales.com", 100000)
e2 = DataAnalyst("Bob", "bob@brightsales.com", "Python")
e3 = Intern("Charlie", "charlie@brightsales.com", "Market Research")

print("SalesManager:")
e1.send_email("Monthly Report", "Please find the attached sales report.")
e1.track_sales()

print("DataAnalyst:")
e2.send_email("Data Analysis", "The data analysis report is ready.")
e2.analyze_data()

print("Intern:")
e3.send_email("Project Update", "The project is progressing well.")
e3.work_on_project()