...
model = joblib.load("D:/Python/Exercise/5 - Machine Learning/5.3 - Pipeline/2model.joblib")

new_messages = pd.DataFrame({
    "message": ["Hey, are you coming to the office tomorrow? I need that report by 10 AM.",
